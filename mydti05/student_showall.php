...
<body>
        ...
        if ($numRow > 0) {
                ...
                echo "<tr><td>รหัส</td><td>รูป</td><td>ชื่อ-สกุล</td><td>คำแนนรวม</td><td>GPA</td><td>UPDATE/DELETE</td></tr>";

                while ($dataRow = $result->fetch(PDO::FETCH_ASSOC)) {
                        extract($dataRow);
                        echo "<tr>";
                        echo "<td>" . $stuId . "</td>";
                        // เช็ครูปภาพว่ามีไฟล์รูปหรือไม่ ถ้ามีให้แสดง ถ้าไม่มีให้แสดงรูป logo.png
