...
<body>
        ...
        if (!empty($_POST)) {
                ...
                //ตรวจสอบว่ามีการแก้ไขรูปไหม คือ มีการอัปโหลดไฟล์มาหรือเปล่า
                ...
                if ($student->updateStudentByStuId()) {
                        echo "<h3>บันทึก (แก้ไข) เรียบร้อยแล้ว....^_^</h3>";
                } else {
                        echo "<h3>บันทึก (แก้ไข) ไม่สำเร็จ กรุณาลองใหม่หรือติดต่อ IT .... T_T</h3>";
                }
